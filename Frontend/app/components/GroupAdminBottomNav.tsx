...
const navItems: {
  ...
  { key: 'record-expenses', label: 'Expenses', icon: 'receipt', route: '/(groupadmin)/record-expenses' },
  { key: 'record-contributions', label: 'Payments', icon: 'card', route: '/(groupadmin)/record-contributions' },
  ...
  { key: 'chat-monitoring', label: 'Chat Monitoring', icon: 'chatbubbles', route: '/(groupadmin)/monitor' },
];
