...
export default function GroupContributionsScreen() {
  ...
  // Effect to fetch initial group, contribution, and expense data
  useEffect(() => {
        ...
        {loading ? (
          ...
          filteredGroups.map((group) => (
            <View key={group.id} style={styles.groupCard}>
              ...
              {/* Total Contributions Line - EXACTLY AS IN YOUR IMAGE */}
              <Text style={styles.totalText}>
                Total Contributions: KES {group.totalAmount.toLocaleString()}
              </Text>

              {/* ADDED: Two lines for expenses and balance */}
              ...
              <Text style={[
                ...
                Current Balance: KES {group.currentBalance.toLocaleString()}
              </Text>

              {/* ADDED: Contribution History Title with styling */}
              <View style={styles.historyHeader}>
                <Text style={styles.historyTitle}>Contribution History</Text>
              </View>

              {/* Contributions List - EXACTLY AS IN YOUR IMAGE */}
...
const styles = StyleSheet.create({
  ...
  // Total Contributions - EXACTLY AS IN YOUR IMAGE
  ...
  // ADDED: Contribution History Header Styles
  historyHeader: {
    borderBottomWidth: 2,
